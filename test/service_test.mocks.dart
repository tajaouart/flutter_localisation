...
// in flutter_localisation/test/service_test.dart.
...
import 'package:flutter_localisation/src/api/api_repository.dart' as _i3;
...
class MockApiRepository extends _i1.Mock implements _i3.ApiRepository {
  ...
  @override
  _i4.Future<Map<String, dynamic>?> fetchUpdates(String? currentTimestamp) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchUpdates,
          [currentTimestamp],
